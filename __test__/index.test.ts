...
Deno.test("validator test 1", () => {
    const url = "https://discordapp.com/api/webhooks/1187964421344079932/nq8hOq79N4QldaXsaef-23sUZlhBIPEIljmRxEALauzMPpD4ZTf_10mRieasKiA5c8-C";
    const result = webhookURLValidator(url);
    assertEquals<string | false>(result, `https://discordapp.com/api/webhooks/1187964421344079932/nq8hOq79N4QldaXsaef-23sUZlhBIPEIljmRxEALauzMPpD4ZTf_10mRieasKiA5c8-C`);
})
...
Deno.test("context test", () => {
    ...
    const dwh = new DiscordWebhook("https://discordapp.com/api/webhooks/1187964421344079932/nq8hOq79N4QldaXsaef-23sUZlhBIPEIljmRxEALauzMPpD4ZTf_10mRieasKiA5c8-C");
